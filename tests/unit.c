...
void rununit() {
    ...
    {
        uint32_t crc = crc32((const uint8_t*)input, strlen(input));
    ...
    }
    {
        ...
        md5((const uint8_t*)input, strlen(input), output);
    ...
    }
    {
        ...
        sha1((const uint8_t*)input, strlen(input), output);
    ...
    }
    {
        ...
        sha2_224((const uint8_t*)input, strlen(input), output);
    ...
    }
    {
        ...
        sha2_256((const uint8_t*)input, strlen(input), output);
    ...
    }
    {
        ...
        sha2_384((const uint8_t*)input, strlen(input), output);
    ...
    }
    {
        ...
        sha2_512((const uint8_t*)input, strlen(input), output);
    ...
    }
    {
        ...
        sha2_512_224((const uint8_t*)input, strlen(input), output);
    ...
    }
    {
        ...
        sha2_512_256((const uint8_t*)input, strlen(input), output);
...

    {
        ...
        sha3_224((const uint8_t*)input, strlen(input), output);
    ...
    }
    {
        ...
        sha3_384((const uint8_t*)input, strlen(input), output);
    ...
    }
    {
        ...
        sha3_512((const uint8_t*)input, strlen(input), output);
    ...
    }
    {
        ...
        keccak_224((const uint8_t*)input, strlen(input), output);
    ...
    }
    {
        ...
        keccak_256((const uint8_t*)input, strlen(input), output);
    ...
    }
    {
        ...
        keccak_384((const uint8_t*)input, strlen(input), output);
    ...
    }
    {
        ...
        keccak_512((const uint8_t*)input, strlen(input), output);
