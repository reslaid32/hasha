...
void rununit()
{
  ...
  }
  {
    ...
    assert(compare_hash(output, expected_hash, SHA2_512_224_DIGEST_SIZE) ==
           0);
  ...
  }
  {
    ...
    assert(compare_hash(output, expected_hash, SHA2_512_256_DIGEST_SIZE) ==
           0);
  ...
  }
  {
    ...
    assert(compare_hash(output, expected_hash, KECCAK_224_DIGEST_SIZE) ==
           0);
  ...
  }
  {
    ...
    assert(compare_hash(output, expected_hash, KECCAK_256_DIGEST_SIZE) ==
           0);
  ...
  }
  {
    ...
    assert(compare_hash(output, expected_hash, KECCAK_384_DIGEST_SIZE) ==
           0);
  ...
  }
  {
    ...
    assert(compare_hash(output, expected_hash, KECCAK_512_DIGEST_SIZE) ==
           0);
