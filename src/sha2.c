...
HA_PUBFUN void
ha_sha2_224_transform (ha_sha2_224_context *ctx, const uint8_t *block)
{
  ha_sha2_256_transform ((ha_sha2_256_context *)ctx, block);
}

HA_PUBFUN void
ha_sha2_224_init (ha_sha2_224_context *ctx)
{
...
HA_PUBFUN void
ha_sha2_224_update (ha_sha2_224_context *ctx, ha_inbuf_t data, size_t length)
{
  ha_sha2_256_update ((ha_sha2_256_context *)ctx, data, length);
}

HA_PUBFUN void
ha_sha2_224_final (ha_sha2_224_context *ctx, ha_digest_t digest)
{
...
HA_PUBFUN void
ha_sha2_224_hash (ha_inbuf_t data, size_t length, ha_digest_t digest)
{
...
HA_PUBFUN void
ha_sha2_256_transform (ha_sha2_256_context *ctx, const uint8_t *block)
{
  uint32_t W[64];
  ...
  for (int t = 0; t < 16; t++)
    {
      uint32_t word;
      memcpy (&word, block + t * 4, 4);
      W[t] = be32_to_cpu (word);
    }
#endif
  ...
  for (int t = 0; t < 64; ++t)
    {
      uint32_t T1 = h + ha_primitive_Sigma1_32 (e) + ha_primitive_ch (e, f, g)
                    + HA_SHA2_256_K[t] + W[t];
...
HA_PUBFUN void
ha_sha2_256_init (ha_sha2_256_context *ctx)
{
...
HA_PUBFUN void
ha_sha2_256_update (ha_sha2_256_context *ctx, ha_inbuf_t data, size_t length)
{
...
HA_PUBFUN void
ha_sha2_256_final (ha_sha2_256_context *ctx, ha_digest_t digest)
{
  size_t buffer_fill = ctx->bit_count / 8 % HA_SHA2_256_BLOCK_SIZE;
...
HA_PUBFUN void
ha_sha2_256_hash (ha_inbuf_t data, size_t length, ha_digest_t digest)
{
...
HA_PUBFUN void
ha_sha2_384_transform (ha_sha2_384_context *ctx, const uint8_t *block)
{
  ha_sha2_512_transform ((ha_sha2_512_context *)ctx, block);
}

HA_PUBFUN void
ha_sha2_384_init (ha_sha2_384_context *ctx)
{
...
HA_PUBFUN void
ha_sha2_384_update (ha_sha2_384_context *ctx, ha_inbuf_t data, size_t length)
{
  ha_sha2_512_update ((ha_sha2_512_context *)ctx, data, length);
}

HA_PUBFUN void
ha_sha2_384_final (ha_sha2_384_context *ctx, ha_digest_t digest)
{
...
HA_PUBFUN void
ha_sha2_384_hash (ha_inbuf_t data, size_t length, ha_digest_t digest)
{
...
HA_PUBFUN void
ha_sha2_512_transform (ha_sha2_512_context *ctx, const uint8_t *block)
{
  uint64_t m[80];
  ...
  for (int i = 0; i < 16; ++i)
    {
      m[i]
          = ((uint64_t)block[i * 8] << 56) | ((uint64_t)block[i * 8 + 1] << 48)
...
HA_PUBFUN void
ha_sha2_512_init (ha_sha2_512_context *ctx)
{
...
HA_PUBFUN void
ha_sha2_512_update (ha_sha2_512_context *ctx, ha_inbuf_t data, size_t len)
{
...
HA_PUBFUN void
ha_sha2_512_final (ha_sha2_512_context *ctx, ha_digest_t digest)
{
  size_t buffer_fill = (ctx->bit_count / 8) % HA_SHA2_512_BLOCK_SIZE;
  ctx->buffer[buffer_fill++] = 0x80;
...
HA_PUBFUN void
ha_sha2_512_hash (ha_inbuf_t data, size_t length, ha_digest_t digest)
{
...
HA_PUBFUN void
ha_sha2_512_224_transform (ha_sha2_512_224_context *ctx, const uint8_t *block)
{
  ha_sha2_512_transform ((ha_sha2_512_context *)ctx, block);
}

HA_PUBFUN void
ha_sha2_512_224_init (ha_sha2_512_224_context *ctx)
{
...
HA_PUBFUN void
ha_sha2_512_224_update (ha_sha2_512_224_context *ctx, ha_inbuf_t data,
                        size_t length)
{
  ha_sha2_512_update ((ha_sha2_512_context *)ctx, data, length);
}
...
HA_PUBFUN void
ha_sha2_512_224_final (ha_sha2_512_224_context *ctx, ha_digest_t digest)
{
  uint8_t full_digest[HA_SHA2_512_DIGEST_SIZE];
  ha_sha2_512_final ((ha_sha2_512_context *)ctx, full_digest);
...
HA_PUBFUN void
ha_sha2_512_224_hash (ha_inbuf_t data, size_t length, ha_digest_t digest)
{
...
HA_PUBFUN void
ha_sha2_512_256_transform (ha_sha2_512_256_context *ctx, const uint8_t *block)
{
  ha_sha2_512_transform ((ha_sha2_512_context *)ctx, block);
}

HA_PUBFUN void
ha_sha2_512_256_init (ha_sha2_512_256_context *ctx)
{
...
HA_PUBFUN void
ha_sha2_512_256_update (ha_sha2_512_256_context *ctx, ha_inbuf_t data,
                        size_t length)
{
  ha_sha2_512_update ((ha_sha2_512_context *)ctx, data, length);
}
...
HA_PUBFUN void
ha_sha2_512_256_final (ha_sha2_512_256_context *ctx, ha_digest_t digest)
{
  uint8_t full_digest[HA_SHA2_512_DIGEST_SIZE];
  ha_sha2_512_final ((ha_sha2_512_context *)ctx, full_digest);
...
HA_PUBFUN void
ha_sha2_512_256_hash (ha_inbuf_t data, size_t length, ha_digest_t digest)
{
