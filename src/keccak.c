...
HA_PUBFUN void
ha_keccak_init (ha_keccak_context *ctx, size_t rate)
{
...
HA_PUBFUN
void
ha_keccak_update (ha_keccak_context *ctx, ha_inbuf_t buf, size_t len)
{
...
HA_PUBFUN
void
ha_keccak_final (ha_keccak_context *ctx, enum ha_pb padbyte,
...
HA_PUBFUN
void
ha_keccak_hash (size_t rate, enum ha_pb padbyte, ha_inbuf_t buf, size_t len,
                ha_digest_t digest, size_t digestlen)
{
...
HA_PUBFUN void
ha_keccak_224_init (ha_keccak_context *ctx)
{
  ha_imp_keccak_init (ctx, HA_KECCAK_224_RATE);
}

HA_PUBFUN void
ha_keccak_224_update (ha_keccak_context *ctx, ha_inbuf_t data, size_t length)
{
  ha_imp_keccak_update (ctx, data, length);
}

HA_PUBFUN void
ha_keccak_224_final (ha_keccak_context *ctx, ha_digest_t digest)
{
...
HA_PUBFUN void
ha_keccak_256_init (ha_keccak_context *ctx)
{
  ha_imp_keccak_init (ctx, HA_KECCAK_256_RATE);
}

HA_PUBFUN void
ha_keccak_256_update (ha_keccak_context *ctx, ha_inbuf_t data, size_t length)
{
  ha_imp_keccak_update (ctx, data, length);
}

HA_PUBFUN void
ha_keccak_256_final (ha_keccak_context *ctx, ha_digest_t digest)
{
...
HA_PUBFUN void
ha_keccak_384_init (ha_keccak_context *ctx)
{
  ha_imp_keccak_init (ctx, HA_KECCAK_384_RATE);
}

HA_PUBFUN void
ha_keccak_384_update (ha_keccak_context *ctx, ha_inbuf_t data, size_t length)
{
  ha_imp_keccak_update (ctx, data, length);
}

HA_PUBFUN void
ha_keccak_384_final (ha_keccak_context *ctx, ha_digest_t digest)
{
...
HA_PUBFUN void
ha_keccak_512_init (ha_keccak_context *ctx)
{
  ha_imp_keccak_init (ctx, HA_KECCAK_512_RATE);
}

HA_PUBFUN void
ha_keccak_512_update (ha_keccak_context *ctx, ha_inbuf_t data, size_t length)
{
  ha_imp_keccak_update (ctx, data, length);
}

HA_PUBFUN void
ha_keccak_512_final (ha_keccak_context *ctx, ha_digest_t digest)
{
