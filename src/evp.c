...
typedef void (*ha_evp_flexible_hash_fn) (ha_inbuf_t, size_t, ha_digest_t,
                                         size_t);
typedef void (*ha_evp_keccak_hash_fn) (size_t, enum ha_pb, ha_inbuf_t, size_t,
                                       ha_digest_t, size_t);
...
static const char *g_ha_evp_hashty_strings[8] = {
  "blake2b", "blake2s", "blake3", "keccak", "md5", "sha1", "sha2", "sha3"
};

HA_PUBFUN
const char *
ha_evp_hashty_tostr (enum ha_evp_hashty hashty)
{
  size_t hashty_n
...
HA_PUBFUN
size_t
ha_evp_hasher_ctxsize (struct ha_evp_hasher *hasher)
{
...
HA_PUBFUN
enum ha_evp_hashty
ha_evp_hasher_hashty (struct ha_evp_hasher *hasher)
{
...
HA_PRVFUN
void
ha_evp_setup_hasher (struct ha_evp_hasher *hasher)
{
    ...
    case HA_EVPTY_MD5:
      {
        ...
        hasher->final_fn.generic = (ha_evp_generic_final_fn)ha_final_fun (md5);
        hasher->final_fn_mod = HA_EVPHR_MOD_GENERIC;
    ...
    case HA_EVPTY_BLAKE3:
      {
        ...
        hasher->init_fn.generic = (ha_evp_generic_init_fn)ha_init_fun (blake3);
        hasher->init_fn_mod = HA_EVPHR_MOD_GENERIC;
...
HA_PRVFUN
bool
ha_evp_allocate_context (struct ha_evp_hasher *hasher)
{
  if (hasher->ctx_allocated)
    return 0;
...
HA_PRVFUN
void
ha_evp_free_context (struct ha_evp_hasher *hasher)
{
...
HA_PUBFUN
void
ha_evp_hasher_delete (struct ha_evp_hasher *ptr)
{
  free (ptr);
}
...
HA_PUBFUN
void
ha_evp_hasher_init (struct ha_evp_hasher *hasher, enum ha_evp_hashty hashty,
                    size_t digestlen)
{
...
HA_PUBFUN
void
ha_evp_hasher_reinit (struct ha_evp_hasher *hasher, enum ha_evp_hashty hashty,
                      size_t digestlen)
{
...
HA_PUBFUN
void
ha_evp_hash (struct ha_evp_hasher *hasher, ha_inbuf_t buf, size_t len,
             ha_digest_t digest)
{
  if (!(hasher))
    return ha_throw_error (ha_curpos, g_ha_evp_error_strings[ARG_VALUE_ERROR],
...
HA_PUBFUN
void
ha_evp_digest (struct ha_evp_hasher *hasher, ha_inbuf_t buf, size_t len,
               ha_digest_t digest)
{
  ha_evp_init (hasher);
