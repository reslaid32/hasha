...
void print_usage(const char *program_name) {
    ...
    printf("\nVerify mode:\n");
    printf("  -verify <hash>     Verify the result against the expected hash\n");
}
...
int verify_hash(const uint8_t *calculated_digest, size_t digest_size, const char *expected_hash) {
